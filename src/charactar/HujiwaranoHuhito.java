...
public class HujiwaranoHuhito extends Character {
	
	public HujiwaranoHuhito() {
		this.name = "藤原不比等"; // 名前・不変
		this.type = 1; // 属性（一番高いステータス）・不変
		this.rare = 1; // レアリティ・可変
		this.era = "奈良"; // 活躍した時代・不変
		int hp; // HP・不変
		this.physical = 80; // 闘ステータス・可変
		this.intelligence = 160; // 知ステータス・可変
